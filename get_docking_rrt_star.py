...
def get_docking_rrt_star(posR, posS, NFZ_centers, NFZ_radii, bounds, cost_type, alpha, beta):
    ...
    J_path = cost_fwd + cost_bwd
    J_alt = (path_smooth[Ndim, 2] - z_pref)**2
    J_skew = (cost_fwd - cost_bwd)**2
    ...
    docking_cost = J_all[best_idx_local]
    best_idx = Ndim[best_idx_local]  # Convert to true index in original path
    docking_point = path_smooth[best_idx]
